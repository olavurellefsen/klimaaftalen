      ...
      {(props.scenarioSelection.showWelcome===true) && <Welcome closeWelcome={props.closeWelcome} />}
        {(props.scenarioSelection.showDifference===false || (props.scenarioSelection.showDifference===true && selectedScenario2==="")) && 
          <Flex>
            ...
            <StackedBarChart chartName='_El netto eksport' chartTitle='El-netto-eksport' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={true} label="PJ" label2="Netto eksport (PJ)" minY={-100} maxY={240}  minY2={-100} maxY2={160} Y2Percentage={false} />
            ...
            <StackedBarChart chartName='_Husholdningers varmeforbrug' chartTitle='Husholdningers varmeforbrug' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={true} label="PJ" label2="Energibesparelser (PJ)" minY={0} maxY={160} minY2={0} maxY2={24} Y2Percentage={false} />
            <StackedBarChart chartName='_Industriens energiforbrug' chartTitle='Industriens energiforbrug' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={true} label="PJ" label2="Energibesparelser (PJ)" minY={0} maxY={400} minY2={0} maxY2={60} Y2Percentage={false} />
        ...
        {(props.scenarioSelection.showDifference===true && selectedScenario2!=="") && 
          <Flex>
            ...
            <StackedBarDiffChart chartName='_El netto eksport' chartTitle='El-netto-eksport' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={true} label="PJ" label2="Netto eksport (PJ)" minY={-200} maxY={200}  minY2={-60} maxY2={60} Y2Percentage={false} />
            ...
            <StackedBarDiffChart chartName='_Husholdningers varmeforbrug' chartTitle='Husholdningers varmeforbrug' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={true} label="PJ" label2="Energibesparelser (PJ)" minY={-8} maxY={8} minY2={-5} maxY2={5} Y2Percentage={false} />
            <StackedBarDiffChart chartName='_Industriens energiforbrug' chartTitle='Industriens energiforbrug' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={true} label="PJ" label2="Energibesparelser (PJ)" minY={-100} maxY={100} minY2={-5} maxY2={5} Y2Percentage={false} />
