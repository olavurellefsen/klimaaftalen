      ...
      {(props.scenarioSelection.showWelcome===true) && <Welcome closeWelcome={props.closeWelcome} />}
        {(props.scenarioSelection.showDifference===false || (props.scenarioSelection.showDifference===true && selectedScenario2==="")) && 
          <Flex>
            ...
            <StackedBarChart chartName='_TRA_Transport passager km' chartTitle='Transport passager km' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={false} label="Pkm" minY={0} maxY={400000} />
            <StackedBarChart chartName='_TRA_Transport investering i lades' chartTitle='Investering i ladestander' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={false} label="Mkr" minY={0} maxY={1500} />
            <StackedBarChart chartName='_TRA_Transport gods km' chartTitle='Gods km' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={false} label="tkm" minY={0} maxY={400000} />
            <StackedBarChart chartName='_TRA_Transport CO2 emissioner' chartTitle='CO2 emissioner' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={false} label="kt" minY={0} maxY={40000} />
            <StackedBarChart chartName='_TRA_Transport brændslesforbrug lu' chartTitle='Brændselsforbrug luftfart' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={false} label="PJ" minY={0} maxY={300} />
            <StackedBarChart chartName='_TRA_Transport brændselsforbrug sø' chartTitle='Brændselsforbrug søfart' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={false} label="PJ" minY={0} maxY={300} />
        ...
        {(props.scenarioSelection.showDifference===true && selectedScenario2!=="") && 
          <Flex>
            ...
            <StackedBarDiffChart chartName='_TRA_Transport passager km' chartTitle='Transport passager km' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={false} label="Pkm" minY={-40000} maxY={40000} />
            ...
            <StackedBarDiffChart chartName='_TRA_Transport gods km' chartTitle='Gods km' selectedScenario={selectedScenario} selectedScenario2={selectedScenario2} combinedChart={false} label="tkm" minY={-200000} maxY={200000} />
